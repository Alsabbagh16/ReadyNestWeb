    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-lg md:max-w-2xl lg:max-w-3xl">
        <DialogHeader>
          ...
          <DialogDescription>
            {editingEmployee ? 'Update the details for this employee. Password can be updated below.' : 'Enter the details for the new employee. This will also create their Supabase Auth user.'}
          </DialogDescription>
        </DialogHeader>
        {formError && (
