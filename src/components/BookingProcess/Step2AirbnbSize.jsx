  ...
  <motion.div variants={stepVariants} initial="initial" animate="animate" exit="exit" transition={stepVariants.transition}>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      <SelectionCard
        ...
        imageDescription="A stylish and compact studio apartment, well-lit and organized"
      ...
      <SelectionCard
        ...
        imageDescription="A cozy living area in a 2-bedroom apartment, ready for guests"
      ...
      <SelectionCard
        ...
        imageDescription="An open-plan living and dining area in a large 3-bedroom apartment"
