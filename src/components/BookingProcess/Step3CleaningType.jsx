  ...
  <motion.div variants={stepVariants} initial="initial" animate="animate" exit="exit" transition={stepVariants.transition}>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <SelectionCard
        ...
        imageDescription="A kitchen gleaming after a thorough one-time cleaning service"
      ...
      <SelectionCard
        ...
        imageDescription="A wall calendar with cleaning appointments marked for a routine service"
