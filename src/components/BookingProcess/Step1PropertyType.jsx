  ...
  <motion.div variants={stepVariants} initial="initial" animate="animate" exit="exit" transition={stepVariants.transition}>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <SelectionCard
        ...
        imageDescription="A bright and airy living room with comfortable furniture and large windows"
      ...
      <SelectionCard
        ...
        imageDescription="A modern apartment balcony with city views and outdoor seating"
