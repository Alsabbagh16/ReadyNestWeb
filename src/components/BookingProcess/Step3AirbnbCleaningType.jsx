  ...
  <motion.div variants={stepVariants} initial="initial" animate="animate" exit="exit" transition={stepVariants.transition}>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <SelectionCard
        ...
        imageDescription="A set of cleaning supplies and fresh linens prepared for an Airbnb turnover clean"
      ...
      <SelectionCard
        ...
        imageDescription="A calendar with a recurring weekly cleaning appointment marked for an Airbnb"
