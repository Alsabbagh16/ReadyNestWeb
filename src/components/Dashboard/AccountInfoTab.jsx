...
import { Eye, EyeOff, Phone } from 'lucide-react'; // Added Phone icon
import { Badge } from "@/components/ui/badge";

// Extracted PersonalDetailsForm
const PersonalDetailsForm = ({ initialData, onSave, isEditing, authLoading, userProvider }) => {
  ...
  useEffect(() => {
    if (initialData.profile) {
      ...
      setPhone(initialData.profile.phone || ''); // Set phone from profile
  ...
  const handleSave = () => {
    onSave({
      ...
      last_name: lastName,
      phone: phone, // Include phone in saved data
      dob,
      user_type: userType,
    });
  };
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-2">
          ...
          <Input id="dash-phone" type="tel" value={phone} onChange={(e) => setPhone(e.target.value)} disabled={!isEditing || authLoading} placeholder="Your phone number" />
        </div>
        <div className="space-y-2">
