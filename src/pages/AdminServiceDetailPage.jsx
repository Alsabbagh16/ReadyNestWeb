...
const AdminServiceDetailPage = () => {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      if (bookingData) {
        ...
        setUser(customer);
        setEditFormData({
          date: bookingData.booking_date ? new Date(bookingData.booking_date).toISOString().split('T')[0] : '',
          time: bookingData.booking_date ? new Date(bookingData.booking_date).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', hour12: false }) : '',
  ...
  const handleEditCancel = () => {
      setEditFormData({
          ...
          time: booking?.booking_date ? new Date(booking.booking_date).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', hour12: false }) : '',
